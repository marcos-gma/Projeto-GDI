...
-- Definindo o tipo de telefone
CREATE OR REPLACE TYPE TELEFONE AS OBJECT (
    NUMERO VARCHAR2(15)
);
/

-- Definindo a tabela aninhada para telefones
CREATE OR REPLACE TYPE TELEFONES_NESTED AS TABLE OF TELEFONE;
/
